!--------------------------------------------------------
!--------------------------------------------------------
!   eulerNL: Solution to the elastica with boundary force
...
!     ---------- ----
      ...
      !DOUBLE PRECISION Th, Thp, X, Y, PX
      DOUBLE PRECISION Th, Thp, X, Y, PY
       ...
       Y=U(4)
       F(1)=Thp
       !F(2)=+PX*SIN(Th)-PAR(1)*COS(Th)
       F(2)=PAR(1)*SIN(Th)-PY*COS(Th)
       F(3)=COS(Th)
       F(4)=SIN(Th)
